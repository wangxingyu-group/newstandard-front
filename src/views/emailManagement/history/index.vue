    ...
    <el-row>
      <el-col :span="24">
        <el-card>
          ...
          <el-table :key="tableKey" v-loading="listLoading" :data="list" :height="searchRow1" fit stripe highlight-current-row style="width: 100%;" @sort-change="()=>{}" @selection-change="selectionChange">
            <el-table-column type="selection" width="55" />
            <el-table-column label="收件人" prop="phoneNo" sortable="custom" align="center" width="200">
              <template slot-scope="scope"><span>{{ scope.row.phoneNo }}</span></template>
            </el-table-column>
            <el-table-column label="邮件内容" align="center">
...
<script>
import { createPreCustomer, fetchList, updatePreCustomer } from '@/api/emailManagement/history'
