<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      />
      <el-input v-model="listQuery.temName" placeholder="服务类型	" style="width: 180px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.temName" placeholder="服务单号	" style="width: 180px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-select slot="prepend" v-model="select" placeholder="任务状态" style="margin-bottom: 10px;vertical-align:middle;display: inline-block;">
        <el-option
