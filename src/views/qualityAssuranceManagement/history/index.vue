              ...
              <el-row>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="通话流水号">
                    <el-input v-model="listQuery.temName" placeholder="通话流水号" style="width:100%;min-width:135px" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="坐席工号">
                    <el-input v-model="listQuery.temName" placeholder="坐席工号" style="width:100%;min-width:135px" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="来电号码">
                    <el-input v-model="listQuery.temName" placeholder="来电号码" style="width:100%;min-width:135px" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :sm="12" :lg="8">
                  <el-form-item label="服务类型">
                    <el-input v-model="listQuery.temName" placeholder="服务类型	" style="width:100%;min-width:135px" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="服务单号">
                    <el-input v-model="listQuery.temName" placeholder="服务单号	" style="width:100%;min-width:135px" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
...
<script>
import { createPreCustomer, fetchList, updatePreCustomer } from '@/api/demo/quality/history/history'
import Pagination from '@/components/Pagination' // secondary package based on el-pagination

export default {
  name: 'History', // 该组件名称为Quality大写Q或者驼峰标志
