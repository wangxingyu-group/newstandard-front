      ...
      <el-col :span="24">
        <el-card>
              ...
              <el-row>
                ...
                <el-col :sm="12" :lg="9">
                  <el-form-item label="坐席组">
                    <el-select v-model="listQuery.siteGroup" style="width: 95%;" placeholder="坐席组">
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow2" :data="list" fit stripe highlight-current-row style="width: 100%;" @sort-change="sortChange" @selection-change="selectionChange">
            ...
            <el-table-column label="呼出被叫平均振铃时长" align="center" min-width="250">
              <template slot-scope="scope"><span>{{ scope.row.timer_clock }}</span></template>
            </el-table-column>
            <el-table-column label="呼出总时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="呼入咨询量" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.num }}</span></template>
            </el-table-column>
            <el-table-column label="呼入平均咨询时间" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="呼出咨询量" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.num }}</span></template>
            </el-table-column>
            <el-table-column label="呼出平均咨询时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="呼入会议量" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.num }}</span></template>
            </el-table-column>
            <el-table-column label="呼入平均会议时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="呼出转接量" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.num }}</span></template>
            </el-table-column>
            <el-table-column label="话后量" align="center" min-width="100">
              <template slot-scope="scope"><span>{{ scope.row.num }}</span></template>
            </el-table-column>
            <el-table-column label="话后总时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="平均话后时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="保持量" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.num }}</span></template>
            </el-table-column>
            <el-table-column label="平均保持时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="登陆时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
            <el-table-column label="签入总时长" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.time }}</span></template>
            </el-table-column>
          </el-table>
...
<script>
import { fetchList } from '@/api/demo/chart/chart5'
