      ...
      <el-col :span="24">
        <el-card>
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow1" style="min-height: 300px;" :data="list" fit stripe highlight-current-row @selection-change="selectionChange">
            ...
            <el-table-column label="工单号" align="center" min-width="150">
              <template slot-scope="scope"><span>{{ scope.row.fbserviceno }}</span></template>
            </el-table-column>
            <el-table-column label="投保单号" align="center" min-width="150">
            ...
            <el-table-column label="信函件状态" align="center" min-width="100">
            ...
            <el-table-column label="代理人代码" align="agentcode" min-width="130">
            ...
            <el-table-column label="回访人工号" align="center" min-width="100">
              <template slot-scope="scope"><span>{{ scope.row.userno }}</span></template>
            </el-table-column>
            <el-table-column label="录入时间" align="center" min-width="150">
              <template slot-scope="scope"><span>{{ scope.row.mailsenddate }}</span></template>
            </el-table-column>
            <el-table-column label="最后一次回函时间" align="center" min-width="150">
            ...
            <el-table-column label="所属机构 " align="center" min-width="100">
