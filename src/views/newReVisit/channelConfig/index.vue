      ...
      <el-col :span="24">
        <el-card>
              ...
              <el-row>
                ...
                <el-col :sm="12" :lg="8">
                  <el-form-item label="销售方式">
                    <el-input v-model="listQuery.name" placeholder="销售方式" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  <div class="fr">
                    ...
                    <el-button type="primary" size="small" @click="handleCreate">查询</el-button>
                    <el-button type="success" size="small" @click="handleUpdate">修改</el-button>
                    <el-button type="success" size="small" @click="handleDelete">删除</el-button>
                  </div>
                </el-col>
              </el-row>
            </el-form>
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow2" style="min-height: 300px;" :data="list" fit stripe highlight-current-row @sort-change="sortChange" @selection-change="selectionChange">
            ...
            <el-table-column label="销售方式编码" align="center" min-width="300">
...
<script>
import { createSettings, updateSettings, fetchList } from '@/api/newReVisit/channelConfig'
