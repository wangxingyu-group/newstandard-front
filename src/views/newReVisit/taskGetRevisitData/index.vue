      ...
      <el-col :span="24">
        <el-card>
              ...
              <el-row>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="任务名称">
                    <el-input v-model="listQuery.name" placeholder="任务名称" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="任务分组">
                    <el-input v-model="listQuery.name" placeholder="任务分组" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow1" style="min-height: 300px;" :data="list" fit stripe highlight-current-row @sort-change="sortChange" @selection-change="selectionChange">
            ...
            <el-table-column label="任务名称" align="center" min-width="300">
              <template slot-scope="scope"><span>{{ scope.row.task }}</span></template>
            </el-table-column>
            <el-table-column label="任务分组" align="center" min-width="400">
              <template slot-scope="scope"><span>{{ scope.row.group }}</span></template>
            </el-table-column>
            <el-table-column label="表达式" align="center" min-width="300">
              <template slot-scope="scope"><span>{{ scope.row.expression }}</span></template>
            </el-table-column>
            <el-table-column label="访问地址" align="center" min-width="300">
              <template slot-scope="scope"><span>{{ scope.row.address }}</span></template>
            </el-table-column>
            <el-table-column label="状态" align="center" min-width="300">
            ...
            <el-table-column label="创建时间" align="center" min-width="300">
...
<script>
import { createSettings, updateSettings, fetchList } from '@/api/newReVisit/taskGetRevisitData'
