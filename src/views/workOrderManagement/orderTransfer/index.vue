        ...
        <el-card>
          <div slot="header" class="clearfix">
            <el-form ref="form" :model="form" label-width="100px" size="small">
              <el-row>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="受理日期从" label-width="130px">
                    <el-col :span="11">
                ...
                <el-col :sm="12" :lg="8">
                  <el-form-item label="服务单状态" label-width="130px">
                    <el-select v-model="form.region" style="width:100%;">
                      ...
                      <el-option label="4--完成" value="shanghai" />placeholder="服务单状态"
                    </el-select>
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
          ...
          <el-table ref="table" :key="0" :data="workOrderData" :height="searchRow3" row-key="id" stripe highlight-current-row>
            ...
            <el-table-column label="服务单类型" align="center" min-width="200">
            ...
            <el-table-column label="来电号码" align="center" min-width="200">
              <template slot-scope="scope"><span>{{ scope.row.callInNo }}</span></template>
            </el-table-column>
            <el-table-column label="转办机构" align="center" min-width="100">
            ...
            <el-table-column label="转办岗位" align="center" min-width="100">
