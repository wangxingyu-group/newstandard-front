<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :height="searchRow2" :data="list" fit stripe highlight-current-row style="width: 100%;" @sort-change="sortChange" @selection-change="selectionChange">
      ...
      <el-table-column label="问题序号" prop="id" sortable="custom" align="center" width="150">
        <template slot-scope="scope"><span>{{ scope.row.id }}</span></template>
      </el-table-column>
      <el-table-column label="问题" align="center" width="230">
      ...
      <el-table-column label="保全类型" align="center" width="150">
        <template slot-scope="scope"><span>{{ scope.row.type }}</span></template>
      </el-table-column>
      <el-table-column label="问题类型" align="center" width="200">
        <template slot-scope="scope"><span>{{ scope.row.questionType }}</span></template>
      </el-table-column>
      <el-table-column label="开启/关闭" align="center" width="200">
