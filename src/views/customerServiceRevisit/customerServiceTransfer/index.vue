      ...
      <el-col :span="24">
        <el-card>
              ...
              <el-row>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="订单号">
                    <el-input v-model="listQuery.idNo" placeholder="订单号" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow1" :data="list" fit stripe highlight-current-row style="width: 100%;" @sort-change="sortChange" @selection-change="selectionChange">
            ...
            <el-table-column label="订单号" prop="id" sortable="custom" align="center" min-width="150">
