      ...
      <el-col :span="24">
        <el-card>
              ...
              <el-row>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="班表名称">
                    <el-input v-model="listQuery.name" placeholder="请输入班表名称" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="开始日期" placeholder="请选择开始日期">
                    <el-date-picker type="date" style="width:100%;min-width:135px" placeholder="请选择开始日期" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="结束日期" placeholder="请选择结束日期">
                    <el-date-picker type="date" style="width:100%;min-width:135px" placeholder="请选择结束日期" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow1" :data="list" fit stripe highlight-current-row style="width: 100%;" @sort-change="sortChange" @selection-change="selectionChange">
            ...
            <el-table-column label="班表名称" prop="id" sortable="custom" align="center" min-width="150">
              <template slot-scope="scope"><span>{{ scope.row.className }}</span></template>
            </el-table-column>
            <el-table-column label="开始时间" align="center" min-width="300">
...
<script>
import { fetchList } from '@/api/schedule/timetable'
