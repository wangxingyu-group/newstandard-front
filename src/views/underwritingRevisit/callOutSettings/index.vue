      ...
      <el-col :span="24">
        <el-card>
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow1" style="min-height: 300px;" :data="list" fit stripe highlight-current-row @sort-change="sortChange" @selection-change="selectionChange">
            ...
            <el-table-column label="业务类型标识" align="center" min-width="300">
...
<script>
import { createSettings, fetchList, updateSettings } from '@/api/underwritingRevisit/callOutSettings/callOutSettings'
