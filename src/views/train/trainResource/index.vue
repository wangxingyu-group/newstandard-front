      ...
      <el-col :span="24">
        <el-card>
              ...
              <el-row>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="分类名称">
                    <el-input v-model="listQuery.type" placeholder="分类名称" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :lg="8">
                  <el-form-item label="分类编码" label-width="140px">
                    <el-input v-model="listQuery.name" placeholder="分类编码" class="filter-item" @keyup.enter.native="handleFilter" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  <div class="fr">
                    ...
                    <el-button type="info" size="small" @click="handleBatchDelete">清空</el-button>
                  </div>
                </el-col>
              </el-row>
            </el-form>
          ...
          <el-table :key="tableKey" v-loading="listLoading" :height="searchRow1" style="min-height: 300px;" :data="list" fit stripe highlight-current-row @sort-change="sortChange" @selection-change="selectionChange">
            ...
            <el-table-column label="分类名称" align="center" min-width="150">
              <template slot-scope="scope"><span>{{ scope.row.name }}</span></template>
            </el-table-column>
            <el-table-column label="分类编码" align="center" min-width="150">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="width: 500px; margin-left:80px;">
        <el-form-item label="分类名称" prop="name" label-width="140px">
          <el-input v-model="temp.name" placeholder="分类名称" />
        </el-form-item>
        <el-form-item label="分类编码" prop="id" label-width="140px">
          <el-input v-model="temp.id" placeholder="分类编码" />
        </el-form-item>
        <el-form-item label="上级分类编码" prop="parentId" label-width="140px">
          <el-input v-model="temp.parentId" placeholder="上级分类编码" />
        </el-form-item>
      </el-form>
...
<script>
import { createDictionary, fetchList, updateDictionary, fetchDictionary } from '@/api/train/trainResource'
