...
<script>
import { createCustomer, fetchList, updateCustomer } from '@/api/demo/customer/customer2'
...
export default {
  ...
  methods: {
    ...
    goToDetails() {
      this.$router.push('/customerManagement/customer2/details')
    }
  }
}
</script>
