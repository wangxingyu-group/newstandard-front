<template lang="html">
  <div class="title">
    <h1 style="display: contents;">&nbsp;&nbsp;&nbsp;&nbsp;{{ name }}</h1>
    <div class="legend-wrapper">
      <ul>
        <li v-for="(legend,index) in legendArr" :key="index" :style="styleArr[index]" @mouseout="donwplay(index)" @mouseover="highlight(index)" @click="legendToggle(legend)">
          {{ legend.name }}
        </li>
      </ul>
    </div>
