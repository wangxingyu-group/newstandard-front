...
export default [
  {
    url: '/queryQualityAssurance/list',
    type: 'get',
    response: config => {
  ...
  {
    url: '/queryQualityAssurance/detail',
    type: 'get',
    response: config => {
  ...
  {
    url: '/queryQualityAssurance/create',
    type: 'post',
    response: _ => {
      return {
        code: 20000,
  ...
  {
    url: '/queryQualityAssurance/update',
    type: 'post',
    response: _ => {
      return {
        code: 20000,
